(() => {
  var e = {
      637: (e) => {
        e.exports = {
          showContact: () => {
            ...
            e.innerHTML += '<h1>Contact</h1>';
            let t = document.createElement('div');
            t.classList.add('contact-container');
            let n = document.createElement('div');
            n.classList.add('contact-details');
            let a = document.createElement('p');
            a.innerText = 'Address: 133 Brock Street, Whitby, ON';
            let i = document.createElement('p');
            i.innerText = 'Phone Number: 905-443-3243';
            let d = document.createElement('p');
            (d.innerText = 'Email Address: fryway@gmail.com'),
              n.appendChild(a),
              n.appendChild(i),
              n.appendChild(d),
              t.appendChild(n);
            ...
            s.classList.add('form-field');
            let m = document.createElement('label');
            (m.innerText = 'Name:'), m.setAttribute('for', 'name');
            ...
            p.classList.add('form-field');
            let h = document.createElement('label');
            (h.innerText = 'Phone Number:'), h.setAttribute('for', 'phone');
            let b = document.createElement('input');
            b.setAttribute('name', 'phone'),
              p.appendChild(h),
              p.appendChild(b),
              c.appendChild(p);
            let f = document.createElement('div');
            f.classList.add('form-field');
            let g = document.createElement('label');
            (g.innerText = 'Email Address:'), g.setAttribute('for', 'email');
            ...
            (E.innerText = 'Message:'), E.setAttribute('for', 'message');
            let w = document.createElement('textarea');
            w.setAttribute('name', 'message'),
              C.appendChild(E),
              C.appendChild(w),
              c.appendChild(C);
            let v = document.createElement('button');
            v.classList.add('btn-send'),
              (v.innerText = 'Send'),
              c.appendChild(v),
              t.appendChild(c),
              e.appendChild(t);
      ...
      994: (e) => {
        e.exports = {
          showFooter: () => {
            ...
            let t = document.createElement('footer'),
              n = document.createElement('a');
            (n.href = 'https://www.facebook.com/'),
              n.setAttribute('target', '_blank'),
              n.setAttribute('tabindex', '-1');
            let a = document.createElement('i');
            a.classList += 'fab fa-facebook fa-2x';
            let i = document.createElement('a');
            (i.href = 'https://www.instagram.com/'),
              i.setAttribute('target', '_blank'),
              i.setAttribute('tabindex', '-1');
            let d = document.createElement('i');
            d.classList += 'fab fa-instagram fa-2x';
            let o = document.createElement('a');
            (o.href = 'https://twitter.com/home?lang=en'),
              o.setAttribute('target', '_blank'),
              o.setAttribute('tabindex', '-1');
            let c = document.createElement('i');
            (c.classList += 'fab fa-twitter fa-2x'),
              n.appendChild(a),
              i.appendChild(d),
              o.appendChild(c),
              t.appendChild(n),
      ...
      666: (e, t, n) => {
        const { showMenu: a } = n(83),
          { route: i } = n(138);
        e.exports = {
          showHomepage: () => {
            const e = document.querySelector('.main-container');
            let t = document.createElement('div');
            t.classList.add('hero');
      ...
      138: (e, t, n) => {
        ...
        let r = 'home';
        (0, a.showNavbar)();
        const l = document.querySelector('[data-link="home"]'),
          s = document.querySelector('[data-link="menu"]'),
          m = document.querySelector('[data-link="contact"]'),
          u = document.querySelector('.main-container');
        let p = [l, s, m],
          h = ['home', 'menu', 'contact'];
        function b() {
          switch (((u.innerHTML = ''), r)) {
            case 'home':
            case '':
              (0, i.showHomepage)();
              break;
        ...
        function f() {
          p.forEach((e) => {
            e.addEventListener('click', (e) => {
              (r = e.target.getAttribute('data-link')), g();
            });
          }),
            ('home' === r || '' === r) &&
              document
      ...
      83: (e) => {
        ...
        e.exports = {
          showMenu: () => {
            ...
            (n.innerText = 'Menu'), e.appendChild(n);
            let a = document.createElement('div');
            (a.classList += 'menu-container'),
              t.forEach((e) => {
                let t = document.createElement('div');
                t.classList += 'menu-item';
                let n = document.createElement('h2');
                n.innerText = e.title;
                let i = document.createElement('img');
                (i.classList += 'menu-item-image'), (i.src = e.imageURL);
                let d = document.createElement('p');
                (d.classList += 'menu-item-description'),
                  (d.innerText = e.description);
                let o = document.createElement('span');
                (o.classList += 'menu-item-price'),
                  (o.innerText = e.price),
                  t.appendChild(n),
                  t.appendChild(i),
                  t.appendChild(d),
      ...
      930: (e) => {
        e.exports = {
          showNavbar: () => {
            ...
            n.innerHTML = '<h2>Fryway 33</h2>';
            let a = document.createElement('ul');
            a.classList.add('nav-links');
            let i = document.createElement('li');
            (i.innerText = 'Home'), i.setAttribute('data-link', 'home');
            let d = document.createElement('li');
            (d.innerText = 'Menu'), d.setAttribute('data-link', 'menu');
            let o = document.createElement('li');
            (o.innerText = 'Contact'),
              o.setAttribute('data-link', 'contact'),
              a.appendChild(i),
              a.appendChild(d),
              a.appendChild(o),
              t.appendChild(n),
              ...
              e.appendChild(t);
            let c = document.createElement('div');
            (c.classList += 'main-container'), e.appendChild(c);
          },
        };
      },
    },
